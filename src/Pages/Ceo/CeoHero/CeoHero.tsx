      ...
      >
        ...
        <div className="relative px-15 z-20 w-full text-blue-950 ">
          <div className="flex items-center justify-between w-full">
            <div className="left">
              <h1 className="text-2xl font-normal leading-[28px]">
                O'quv markazingizni qo'shing
              </h1>
              <p className="font text-[14px]  ">
                Bizga qo'shiling va talabalarga eng yaxshi o'quv <br />{" "}
                imkoniyatlarini topishda yordam bering.
              </p>
            ...
            <div className="right">
              <div className="flex items-center gap-2">
                ...
                <span>|</span>
                <h1 className=" text-[20px]">Ceo Sahifasi</h1>
              </div>
            </div>
          </div>
        </div>
